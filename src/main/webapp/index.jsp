...
<div id="mid">
	...
	<div id="left">
		...
		<!-- 底下是专题或频道的文章标题列表 -->
		<jsp:include page="NavServlet?method=indexChannelArticleList&channelId=1"></jsp:include>
		<jsp:include page="NavServlet?method=indexChannelArticleList&channelId=2"></jsp:include>
		<jsp:include page="NavServlet?method=indexChannelArticleList&channelId=3"></jsp:include>
		<jsp:include page="NavServlet?method=indexChannelArticleList&channelId=4"></jsp:include>
